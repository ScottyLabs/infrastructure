      ...
      terranix.terranixConfigurations.governance = {
        ...
        modules = [
          ...
          config.flake.modules.terranix.s3-state
          {
            ...
            # Forgejo provider for the org-level CI secrets below
            ...
            # Org-level CI action secrets forwarded via `secrets: inherit`
            data.forgejo_organization.this.name = "ScottyLabs";
